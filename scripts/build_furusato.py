...
FTITLE = {
    ...
    "rice": "ふるさと納税 米のコスパ最強ランキング2026｜円/kg・定期便・銘柄別でお得に",
    "beef": "ふるさと納税 牛肉のコスパ最強ランキング2026｜円/kg・大容量・訳あり・部位別でお得に",
    "pork": "ふるさと納税 豚肉のコスパ最強ランキング2026｜円/kg・大容量・切り落としでお得に",
    "chicken": "ふるさと納税 鶏肉のコスパ最強ランキング2026｜円/kg・大容量・むね/もも/ささみでお得に",
    "hamburg": "ふるさと納税 ハンバーグのコスパ最強ランキング2026｜円/kg・大容量・個数でお得に",
    "seafood": "ふるさと納税 海鮮のコスパ最強ランキング2026｜円/kg・いくら/カニ/ホタテをお得に",
    "fruit": "ふるさと納税 フルーツのコスパ最強ランキング2026｜円/kg・シャインマスカット/みかん等をお得に",
    "sweets": "ふるさと納税 スイーツ・お菓子のコスパ最強ランキング2026｜量あたり価格でお得に",
...
FDESC = {
    ...
    "diaper": "楽天ふるさと納税のおむつを1枚あたりの価格でコスパランキング。サイズ別・大容量・定期便でお得に。おすすめが分かります。",
    "kitchen-paper": "楽天ふるさと納税のキッチンペーパーを1ロールあたりの価格でコスパランキング。大容量セットでお得に。おすすめが分かります。",
    "rice": "楽天ふるさと納税の米を1kgあたりの価格でコスパランキング。コシヒカリ等の銘柄・定期便を総量換算で比較し、実質いちばんお得な米・おすすめが分かります。",
    "beef": "楽天ふるさと納税の牛肉を1kgあたりの価格でコスパランキング。和牛・黒毛和牛の切り落とし・ステーキ・大容量・訳ありを、定期便も総量換算で比較。おすすめが分かります。",
    "pork": "楽天ふるさと納税の豚肉を1kgあたりの価格でコスパランキング。切り落とし・こま切れ・大容量を比較し、実質いちばんお得なおすすめが分かります。",
    "chicken": "楽天ふるさと納税の鶏肉を1kgあたりの価格でコスパランキング。むね・もも・ささみ・大容量を比較し、実質お得なおすすめが分かります。",
    "hamburg": "楽天ふるさと納税のハンバーグを1kgあたりの価格でコスパランキング。大容量・個数の多いお得なおすすめが分かります。",
    "seafood": "楽天ふるさと納税の海鮮を1kgあたりの価格でコスパランキング。いくら・カニ・ホタテ・うなぎ等を量あたりで比較し、お得なおすすめが分かります。",
    "fruit": "楽天ふるさと納税のフルーツを1kgあたりの価格でコスパランキング。シャインマスカット・みかん・桃等を量あたりで比較し、お得なおすすめが分かります。",
    "sweets": "楽天ふるさと納税のスイーツ・お菓子を量あたりの価格でコスパランキング。大容量・詰め合わせのお得なおすすめが分かります。",
...
FINTRO = {
    ...
    "rice": " 米は<b>1kgあたりの価格（円/kg）</b>がコスパの基本。定期便は総量に換算して比較でき、銘柄より量あたりの安さで選ぶと実質お得です。",
    "beef": " 牛肉は<b>1kgあたりの価格</b>で選ぶのがコスパの基本。<b>切り落とし・こま切れ</b>や<b>大容量・訳あり</b>品は円/kgが安く、量を楽しみたい人にお得です。",
    "pork": " 豚肉は<b>1kgあたりの価格</b>で比較。<b>切り落とし・こま切れ・大容量</b>が円/kgが安くお得です。",
    "chicken": " 鶏肉は<b>1kgあたりの価格</b>で比較。<b>むね肉・大容量</b>は円/kgが特に安く、コスパ重視におすすめです。",
    "hamburg": " ハンバーグは<b>1kgあたり・個数</b>で比較。大容量・個数の多いセットがお得です。",
    "seafood": " 海鮮は<b>1kgあたりの価格</b>で比較。いくら・カニ・ホタテなど、量あたりの安さで選ぶとお得です。",
    "fruit": " フルーツは<b>1kgあたりの価格</b>で比較。<b>訳あり・大容量</b>は円/kgが安く、家庭用にお得です。",
    "sweets": " スイーツは<b>量あたりの価格</b>で比較。大容量・詰め合わせがお得です。",
